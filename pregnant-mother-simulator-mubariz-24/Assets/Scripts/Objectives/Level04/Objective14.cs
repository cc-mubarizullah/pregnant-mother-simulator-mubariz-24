...
public class Objective14 : MonoBehaviour
{
    ...
    public static event EventHandler OnObj14Update;
    public static event EventHandler OnObj14Complete; // declaring an event for objective 1 complete
    ...
    private void Update()
    {
        ...
        objectiveShowUI.ShowObjectiveText(fourteenthObjectiveSO.objectivesText);
        CheckProgress();
    }
    ...
    private void CheckProgress()
    {
        if (hasEatenAllFood)
        {
            ...
            {
                //OBJECTIVE COMPLETE
                fourteenthObjectiveSO.isObjectiveComplete = true;
                // raising event when obj 1 complete
                OnObj14Complete?.Invoke(this, EventArgs.Empty);
